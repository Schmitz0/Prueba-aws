...
conn.sync({ force: true }).then(() => {
  server.listen(PORT, () => {
    ...
    const insumos = [
      ...
      {categoria:"Alimentos", nombre:"ACIDO ASCORBICO", precio:9.2, proveedor:"LG", unidad:"kg", Descripcion:"", imgUrl:""},
      ...
      {categoria:"Alimentos", nombre:"CITRATO DE SODIO", precio:4.6, proveedor:"", unidad:null, Descripcion:"", imgUrl:""},
      ...
      {categoria:"Alimentos", nombre:"JUGO DE NARANJA CLARA", precio:0, proveedor:"", unidad:"lit", Descripcion:"", imgUrl:""},
